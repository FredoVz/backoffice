                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped mb-0"> <!-- style="width: 100%; min-width: 600px; max-width: 100%;" -->
                            <thead id="data-head" style="background-color: #e7dbeb;">
                                <tr>
                                    <th style="width:50%;">Channel ID <i class="bi bi-caret-down-fill"></i></th>
                                    <th style="width:50%;">Channel Name <i class="bi bi-caret-down-fill"></i></th>
                                </tr>
                            </thead>
                            <tbody id="video-container">
                                <?php if (!empty($channels)): ?>
                                    <?php foreach ($channels as $channel): ?>
                                        <tr>
                                            <td style="width:50%;"><?php echo $channel['id']; ?></td>
                                            <td style="width:50%;"><?php echo $channel['name']; ?></td>
                                        </tr>
                                    <?php endforeach; ?>
                                <?php else: ?>
                                    <tr>
